...
parser = argparse.ArgumentParser(description='PyTorch FusionNet inference on a folder of img pairs',
                                 formatter_class=argparse.ArgumentDefaultsHelpFormatter)
parser.add_argument('--data', metavar='DIR', default='Data/traffic',
...
parser.add_argument('--output', metavar='DIR', default="result/traffic/0402",
...
def main():
    ...
    for ext in args.img_exts:
        ...
        for file in test_files:
            img_pair = file.parent / (file[13:16] + 'B.{}'.format(ext))
    ...
    for (img1_file, img2_file) in tqdm(img_pairs):
        ...
        for fusion_output in output:
            ...
            pyplot.imsave(save_path / '{}{}.png'.format(img1_file[13:17], 'Fusion'), to_save)
